...
(function($) {
  ...
  $('.button-search').click(function() {
    ...
    // If is-open class doesn't exist
      ...
      $('.search_modal').delay(500).show("drop", {times: 1, distance: 100}, "slow").animate({"width" : "800px"}, "slow");
      $('.search_modal_inner').animate({"backgroundColor" : "#ededed", "opacity": "1"}, "slow").show("fade", {times: 1, distance: 100}, "slow");
